...
//*
//* intrface.c
//* Version 3.0 - PC file system configuration
//*
...
#include "opcode.h"
#include "intrface.h"
// configuration depending inclusion
#include <stdio.h>
#include <string.h>
	//*===================================================================
	//*
	...
	//* End of design-dependent Global variable
...
//*===================================================================
	...
	int dataGetByte(unsigned char *byteOut, 
		...
		//* You may put your code here.
		//********************************************************************
		// fail condition, return PROC_FAIL
